...
const tools = [
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { id: { type: "string", description: "Document UUID (uid)" } },
      required: ["id"],
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        id: { type: "string", description: "Document UUID (uid)" },
        title: { type: "string", description: "New document title (optional)" },
        content: { type: "string", description: "New document body in Markdown (optional, replaces entire body — see skill: annotations lost without restore)" },
      },
      required: ["id"],
    },
  },
